                    ...
                    <div class="row mb-2">
                        ...
                        <div class="col-sm-6">
                            <ol class="breadcrumb float-sm-right">
                                ...
                                <li class="breadcrumb-item active">Master Sub Pos</li>
                            </ol>
                        </div>
                    </div>
                    <div class="row">
                        ...
                        <div class="col-12">
                            ...
                            <div class="card">
                                <div class="card-header">
                                    <h3 class="card-title"> <a href="<?php echo site_url('C_masterpos_subpos/add_subpos'); ?>" class="btn btn-block btn-info"><i class="fa fa-fw fa-plus"></i> Tambah Pos</a></h3>
                                </div>
                                <!-- /.card-header -->
                                <div class="card-body">
